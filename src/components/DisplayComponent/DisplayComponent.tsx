      ...
      <Paper className={classes.paperComponent}>
        ...
        <Box m={8} className={classes.boxComponent}>
          <div style={{marginBottom: '30px'}}>
            ...
            <Typography variant='h6' color="textSecondary">{uuid}</Typography>
          </div>
          <div  style={{marginBottom: '30px'}}>
            <Typography variant='h5'>Country</Typography>
            <Typography variant='h6' color="textSecondary">{country}</Typography>
          </div>
        </Box>
        <Box m={8} className={classes.boxComponent}>
          <div  style={{marginBottom: '30px'}}>
          ...
          <div  style={{marginBottom: '30px'}}>
            ...
            <Typography variant='h6' color="textSecondary">{phone}</Typography>
          </div>
        </Box>
      </Paper>
    </div>
